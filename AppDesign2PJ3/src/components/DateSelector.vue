...
<style scoped>
    .selector-box {
        ...
        /* ★★★ 正方形にするための指定を追加 ★★★ */
        width: 8rem;  /* 例: 128px。好きなサイズに調整してください */
        height: 8rem; /* widthと同じ値を指定して正方形にします */
