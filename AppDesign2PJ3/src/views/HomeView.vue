...
<template>
  <div class="home-view-container">
    ...
    <div class="offer-list">
        ...
        <img :src="offer.image" :alt="offer.city" class="offer-image">
...
.ticket-card {
  background: url('../image/backgroundSky.jpg') no-repeat center center;
...
.offer-list {
  ...
  gap: 1rem;
  padding-bottom: 1rem; /* スクロールバーのための余白 */
  min-height: 25vh;
}
